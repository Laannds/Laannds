      ...
      <section className="border-y border-gray-100 bg-gray-50/60 py-5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-0 sm:divide-x divide-gray-200">
            <div className="flex items-center gap-3 justify-center sm:px-10">
              <svg className="w-5 h-5 text-orange-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
              </svg>
              <span className="text-sm font-semibold text-gray-700">Cualquier ciudad del mundo</span>
            </div>
            <div className="flex items-center gap-3 justify-center sm:px-10">
              <svg className="w-5 h-5 text-orange-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" />
              </svg>
              <span className="text-sm font-semibold text-gray-700">Resultado en menos de 10 segundos</span>
            </div>
            <div className="flex items-center gap-3 justify-center sm:px-10">
              <svg className="w-5 h-5 text-orange-500 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span className="text-sm font-semibold text-gray-700">Siempre dentro de tu presupuesto</span>
            </div>
          </div>
        </div>
      </section>
